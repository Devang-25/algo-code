...
public class SortColors {
     ...
     public void sortColors2(final int[] nums) {
         if (nums == null || nums.length == 0) {
             return;
         }
     ...
     private void swap(final int[] arr, final int x, final int y) {
     ...
     public static void main(final String[] args) {
         final SortColors sc = new SortColors();
         final int[] colors = new int[] { 1, 0, 1, 2 };
